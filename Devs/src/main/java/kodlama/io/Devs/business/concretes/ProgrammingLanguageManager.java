...
public class ProgrammingLanguageManager implements ProgrammingLanguageService {
	...
	// DEFAULT OLARAK GELEN STRİNG İFADESİ VE NULL DURMUNDA HAYTA VERİYOR ANCAK HATA
	// FIRLATMIYORR
	private boolean isLanguageNull(CreateProgrammingLanguagesRequest createProgrammingLanguagesRequest) {
		if (createProgrammingLanguagesRequest.getName().equals("")
				|| createProgrammingLanguagesRequest.getName().equals("string")) {
			return true;
		}
		return false;
	}
